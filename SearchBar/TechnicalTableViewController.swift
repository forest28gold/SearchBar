...
enum selectedScope4:Int {
    case Types = 2
}

class TechnicalTableViewController: UITableViewController, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.searchBarSetup()
        filterTableView(ind: searchBar.selectedScopeButtonIndex, text: "Germany")
    ...
    func filterTableView(ind: Int, text: String) {
        switch ind {
        case selectedScope4.Types.rawValue:
